        ...
        <div className="mx-auto max-w-3xl">
            ...
            {PACKAGE_ORDER.map((key, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`relative overflow-hidden rounded-2xl border ${isCurrent ? `${planBorderColors[key]} ring-1 ring-primary/20` : "border-border/30"} transition-all ${!isCurrent ? "hover:border-border/50" : ""}`}
          ...
          >
            <div className="flex items-start gap-2.5 rounded-xl border border-border/15 bg-background/20 px-4 py-3">
              <Sparkles size={13} className="shrink-0 text-primary/50 mt-0.5" />
              <p className="text-[11px] text-muted-foreground/60 leading-relaxed">
                When you switch plans, you'll be taken to a secure checkout for the new plan. Your current plan will remain active until the change takes effect.
              </p>
            </div>
            <div className="flex items-start gap-2.5 rounded-xl border border-border/15 bg-background/20 px-4 py-3">
