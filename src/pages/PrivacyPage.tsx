        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
            ...
            <div>
              ...
              <p>For questions about this policy, please reach out to <a href="mailto:support@aivantory.com" className="text-primary hover:underline">support@aivantory.com</a> or call <a href="tel:+18067794074" className="text-primary hover:underline">+1 (806) 779-4074</a>.</p>
            </div>
          </div>
        </motion.div>
      </div>
