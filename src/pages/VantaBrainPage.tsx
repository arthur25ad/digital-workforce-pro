  ...
  <>
    ...
    <section className="relative overflow-hidden px-6 pt-24 pb-20 md:pt-32 md:pb-28 md:px-12 lg:px-16">
      <div className="pointer-events-none absolute inset-0" style={{
        background: "radial-gradient(ellipse 60% 50% at 50% 15%, hsl(217 91% 60% / 0.2), transparent)"
      }} />
      <div className="pointer-events-none absolute inset-0" style={{
        background: "radial-gradient(ellipse 35% 25% at 50% 5%, hsl(217 80% 70% / 0.12), transparent)"
      }} />
      ...
      <div className="mx-auto max-w-[1600px] relative text-center">
        <motion.div {...fadeUp} className="flex justify-center mb-8">
          <div className="relative">
            <div className="flex h-28 w-28 items-center justify-center rounded-[2rem] border border-border/50 bg-card" style={{
              boxShadow: `0 0 80px hsl(217 91% 60% / 0.3), 0 0 160px hsl(217 91% 60% / 0.12), inset 0 1px 0 hsl(0 0% 100% / 0.05)`
            }}>
              <Brain size={56} style={{ color: VEYRA }} />
            </div>
            <div className="absolute -right-2 -top-2 flex h-9 w-9 items-center justify-center rounded-full border border-border/50 bg-card" style={{
              boxShadow: `0 0 20px hsl(217 91% 60% / 0.35)`
            }}>
              <Zap size={16} style={{ color: VEYRA }} />
            </div>
          </div>
        </motion.div>
        ...
        <motion.h1
          ...
          className="font-display text-6xl font-black tracking-tighter sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] leading-[0.85] veyra-gradient-text"
        >
          VEYRA
        </motion.h1>
        ...
        <motion.p
          ...
          style={{ color: "hsl(217 91% 70% / 0.7)" }}
        >
          The intelligence engine that powers your entire AI team.{" "}
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.08 }} className="mb-16">
          <div className="rounded-2xl border border-border/40 bg-card p-6 md:p-8">
            <h2 className="font-display text-center text-2xl font-bold text-foreground md:text-3xl mb-8">
              Three Steps. <span style={{ color: VEYRA }}>Infinite Intelligence.</span>
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                { step: "03", title: "Improve", desc: "Your AI team pulls from Veyra before every action, delivering outputs that feel like you.", icon: Sparkles },
              ].map((s) => (
                <div key={s.step} className="text-center">
                  <span className="font-display text-5xl font-black tracking-tighter" style={{ color: "hsl(217 91% 60% / 0.15)" }}>{s.step}</span>
                  <div className="flex justify-center mt-2 mb-2">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-border/40 bg-background">
                      <s.icon size={18} style={{ color: VEYRA }} />
                    </div>
                  </div>
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.12 }}>
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              { icon: Cpu, title: "Gets Smarter Over Time", desc: "The more you use VANTABRAIN, the better your entire AI team becomes." },
              ...
              >
                <f.icon size={18} style={{ color: VEYRA }} className="mb-3" />
    ...
    <section className="px-6 pb-24 md:px-12 lg:px-16">
      <div className="mx-auto max-w-4xl text-center">
        <motion.div {...fadeUp}>
          <Brain size={28} className="mx-auto mb-3" style={{ color: VEYRA }} />
          <h2 className="font-display text-xl font-bold text-foreground md:text-2xl">
            Ready to build your AI's memory?
          </h2>
          <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground">
            Start using VANTABRAIN and Veyra starts learning from day one.
          </p>
          <div className="mt-6">
            <Link
              to="/auth"
              ...
              style={{
                backgroundColor: "white",
                color: "hsl(217 91% 45%)",
                boxShadow: "0 0 25px hsl(217 91% 60% / 0.15)",
              }}
            >
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden px-6 pt-24 pb-2 md:pt-28 md:px-12 lg:px-16">
        <div className="pointer-events-none absolute inset-0" style={{
          background: "radial-gradient(ellipse 60% 45% at 50% 10%, hsl(217 91% 60% / 0.14), transparent)"
        }} />

        <div className="mx-auto max-w-[1600px] relative text-center">
          <motion.h1
            {...fadeUp}
            className="font-display text-5xl font-black tracking-tight md:text-7xl lg:text-8xl veyra-gradient-text"
          >
            VEYRA
          </motion.h1>
      ...
      <section className="px-6 pb-20 md:px-12 lg:px-16">
        <div className="mx-auto max-w-[1400px]">
              ...
              <div key={s.label} className="rounded-2xl border border-border/40 bg-card p-4 transition-all duration-300 hover:border-border/60">
                <div className="flex items-center gap-2 mb-2">
                  <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-card border border-border/40">
                    <s.icon size={14} style={{ color: VEYRA }} />
                  </div>
                </div>
          ...
          <motion.div {...fadeUp} transition={{ delay: 0.14 }} className="mb-6">
            <div className="rounded-2xl border border-border/40 bg-card p-6">
              <div className="flex items-center gap-2 mb-4">
                <Brain size={16} style={{ color: VEYRA }} />
                <h2 className="font-display text-base font-semibold text-foreground">Business Brain Summary</h2>
              </div>
              <p className="text-sm text-muted-foreground mb-4">
                This is what Veyra currently understands about your business based on your workspace setup and usage patterns.
              </p>
              <div className="grid md:grid-cols-3 gap-3">
                {memories.filter(m => m.scope === "shared").length > 0 ? (
                  ...
                  <div className="col-span-3 rounded-xl border border-dashed border-border/30 p-8 text-center">
                    ...
                    <p className="text-xs text-muted-foreground/60 mt-1">As you use your AI Employees, Veyra will build a profile of your business preferences.</p>
                  </div>
                )}
              </div>
            </div>
          ...
          <motion.div {...fadeUp} transition={{ delay: 0.18 }} className="mb-6">
            <div className="rounded-2xl border border-border/40 bg-card p-6">
              <div className="flex items-center gap-2 mb-4">
                <Layers size={16} style={{ color: VEYRA }} />
              ...
              <div className="grid md:grid-cols-5 gap-4">
                ...
                <div className="md:col-span-3">
                  <div className="flex items-center gap-2 mb-3">
                    <Lightbulb size={14} style={{ color: VEYRA }} />
                        ...
                        return (
                          <div key={m.id} className="group flex items-start gap-3 rounded-xl border border-border/30 bg-background/50 p-3 transition-all hover:border-border/50">
                            <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg border border-border/30 bg-card">
                              <CatIcon size={12} style={{ color: VEYRA }} />
                            </div>
                ...
                <div className="md:col-span-2">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <TrendingUp size={14} style={{ color: VEYRA }} />
                            ...
                            <div className="mt-1.5">
                              <div className="h-1 w-full rounded-full bg-muted/30 overflow-hidden">
                                <div className="h-full rounded-full" style={{
                                  ...
                                  background: `linear-gradient(90deg, ${VEYRA}, hsl(200 80% 60%))`
                                }} />
                              </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <motion.div {...fadeUp} transition={{ delay: 0.22 }}>
              <div className="rounded-2xl border border-border/40 bg-card p-5 h-full">
                <div className="flex items-center gap-2 mb-4">
                  <Plug size={14} style={{ color: VEYRA }} />
            ...
            <motion.div {...fadeUp} transition={{ delay: 0.26 }}>
              <div className="rounded-2xl border border-border/40 bg-card p-5 h-full">
                <div className="flex items-center gap-2 mb-4">
                  <Settings size={14} style={{ color: VEYRA }} />
                ...
                <div className="flex items-center justify-between gap-3 rounded-xl border border-border/30 bg-background/50 p-3 mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-muted-foreground">Temporarily stop Veyra from learning new preferences</p>
                  </div>
                  <Switch
            ...
            <motion.div {...fadeUp} transition={{ delay: 0.3 }}>
              <div className="rounded-2xl border border-border/40 bg-card p-5 h-full">
                <div className="flex items-center gap-2 mb-4">
                  <History size={14} style={{ color: VEYRA }} />
                      ...
                      return (
                        <div key={i} className="flex items-start gap-2.5">
                          <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-border/30 bg-card mt-0.5">
                            {role ? <role.icon size={10} style={{ color: role.color }} /> : <Brain size={10} style={{ color: VEYRA }} />}
                          </div>
                          <div>
